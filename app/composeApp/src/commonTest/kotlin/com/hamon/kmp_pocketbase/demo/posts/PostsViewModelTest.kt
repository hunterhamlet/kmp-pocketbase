...
class PostsViewModelTest {
    ...
    private fun post(id: String = "1", title: String = "T", content: String = "C") =
    ...
    @Test
    fun createPostSuccessUpdatesActionStateToDone() = runTest {
        val vm = viewModel()
    ...
    @Test
    fun createPostFailureTransitionsToError() = runTest {
    ...
    @Test
    fun updatePostSuccessUpdatesActionStateToDone() = runTest {
        val vm = viewModel()
    ...
    @Test
    fun deletePostSuccessUpdatesActionStateToDone() = runTest {
        val vm = viewModel()
        vm.deletePost("1")
        assertIs<PostActionState.Done>(vm.actionState)
    }
    ...
    @Test
    fun deletePostFailureTransitionsToError() = runTest {
    ...
    @Test
    fun resetActionStateSetsStateToIdle() = runTest {
        val vm = viewModel()
        vm.createPost("T", "C")
        vm.resetActionState()
...
private class FakePostsRepository(
    ...
    getResult: PocketBaseResult<List<RecordModel<Post>>> = PocketBaseResult.Success(posts),
    private val mutateResult: PocketBaseResult<RecordModel<Post>> = PocketBaseResult.Success(RecordModel(fields = Post())),
    private val deleteResult: PocketBaseResult<Unit> = PocketBaseResult.Success(Unit),
) : PostsRepository {
    private val _getResult = getResult

    override suspend fun getPosts() = _getResult
    override suspend fun createPost(title: String, content: String) = mutateResult
    override suspend fun updatePost(id: String, title: String, content: String) = mutateResult
