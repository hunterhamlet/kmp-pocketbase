...
class AuthViewModelTest {
    ...
    @Test
    fun loginSuccessTransitionsToSuccess() = runTest {
    ...
    @Test
    fun loginFailureTransitionsToError() = runTest {
    ...
    @Test
    fun registerSuccessTransitionsToSuccess() = runTest {
    ...
    @Test
    fun registerFailureTransitionsToError() = runTest {
    ...
    @Test
    fun refreshSuccessTransitionsToSuccess() = runTest {
    ...
    @Test
    fun logoutResetsStateToIdle() = runTest {
        val vm = viewModel()
        vm.logout()
    ...
    @Test
    fun resetStateSetsStateToIdle() = runTest {
...
private class FakeAuthRepository(
    ...
    override suspend fun register(email: String, password: String, name: String) = registerResult
